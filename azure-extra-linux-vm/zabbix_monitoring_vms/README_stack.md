...
* [**🔹 Table of Contents: Zabbix & Linux Monitoring**](#table-of-contents-zabbix--linux-monitoring)
* [**🔹 Zabbix 6 is installed (upgraded to 7)**](#zabbix-6-is-installed-was-upgraded-to-7)
* [**🔹 Zabbix Trapper items (10051 inbound)**](#zabbix-trapper-items-10051-inbound-to-zabbix-server)
* [**🔹 Install zabbix sender on vm dummy01**](#install-zabbix-sender-on-vm-dummy01-linux-vm)
* [**🔹 Make a trapper item**](#make-a-trapper-item)
* [**🔹 Zabbix Agent: Active 10051 vs Passive 10050**](#zabbix-agent-active-10051-is-not-trapper-vs-passive-10050)
* [**🔹 Install Zabbix agent (Passive 10050)**](#install-zabbix-agent-default-with-passive-checks-and-template-linux-by-zabbix-agent-10050)
    * [Configure Zabbix for monitoring Passive checks](#configure-zabbix-for-monitoring-passive-checks-10050-it-means-that-the-poller-internal-server-process-connects-to-the-agent-on-port-10050tcp-and-polls-for-a-certain-value)
* [**🔹 User Parameters (Optional but Recommended)**](#user-parameters-optional-but-recommended)
* [**🔹 User parameter simple**](#user-parameter-simple)
* [**🔹 User parameter advanced**](#user-parameter-advanced)
* [**🔹 Install Zabbix agent (Active 10051)**](#install-zabbix-agent-and-template-linux-by-zabbix-agent-active-10051)
    * [Active checks data processing overview](#active-checks-all-data-processing-is-performed-on-the-agent-without-the-interference-of-pollers-agent-ask-for-parameters-every-2-min-on-10051)
* [**🔹 Zabbix Agent Configuration Guide**](#zabbix-agent-configuration-guide)
* [**🔹 HA or Multiple Zabbix server by same agent**](#ha-or-multiple-zabbix-server-by-same-agent)
    * [1. Passive Checks (`Server` parameter)](#1-passive-checks-server-parameter)
    * [2. Active Checks (`ServerActive` parameter)](#2-active-checks-serveractive-parameter)
    * [**Typical Use Cases for Multi-Server Monitoring**](#typical-use-cases-for-multi-server-agent-monitoring)
    * [**What a Zabbix Agent Cannot Do**](#what-a-zabbix-agent-cannot-do)
    * [Troubleshooting](#troubleshooting)
    * [Enable ssl tbd](#enable-ssl-tbd)
    * [Upgrade to Zabbix Agent 2](#upgrade-to-zabbix-agent-2)
    * [Templates view folder](#templates-view-folder)
